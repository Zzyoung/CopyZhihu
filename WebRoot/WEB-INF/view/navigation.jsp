	...
	<div class="zg-wrap modal-shifting" id="zh-top-inner">
		...
		<div class="profile">
			<a href="/people/zhang-yang-07-01" class="userinfo ">
				...
				<span style="display:none;" id="zh-top-nav-new-pm" class="zg-noti-number tips-count">2</span>
			</a>
			<ul class="profile-dropdown" id="top-nav-profile-dropdown">
				<li><a href="#"><i class="zg-icon zg-icon-dd-home"></i>我的主页</a></li>
				<li>
					<a href="#">
				...
				<li><a href="#"><i class="zg-icon zg-icon-dd-settings"></i>设置</a></li>
		...
		<div id="zh-top-search" class="zu-top-search">
			<form method="GET" action="/search" id="zh-top-search-form" class="zu-top-search-form form-with-magnify">
				<input type="text" class="zu-top-search-input" name="q" autocomplete="off" value="" placeholder="搜索话题、问题或人…" />
				...
				<div class="zu-top-nav-live-inner zg-r5px">
					...
					<div class="zu-home-noti-inner" id="zh-top-nav-live-new-inner">
						<div class="zm-notice-popup-tab-container clearfix">
							<button id="message-tab" class="zm-notice-popup-tab-item message">
								<span class="icon">消息</span>
							</button>
							<button id="user-tab" class="zm-notice-popup-tab-item user">
								<span class="icon">用户</span>
							</button>
							<button id="thanks-tab" class="zm-notice-popup-tab-item thanks">
					...
					<div class="zm-notice-frame">
						<div id="message-notice-content" class="zm-notice-content zh-sroller">
						...
						<div id="user-notice-content" class="zm-notice-content zh-sroller" style="display:none;">
							<div class="zh-scroller-inner">
								<div class="zh-scroller-content">
									<div class="zm-notice-content-inner">
										<div class="zm-notice-popup-refresh">
						...
						<div id="thanks-notice-content" class="zm-notice-content zh-sroller" style="display:none;">
							<div class="zh-scroller-inner">
								<div class="zh-scroller-content">
									<div class="zm-notice-content-inner">
										<div class="zm-notice-popup-refresh">
